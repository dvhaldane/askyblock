...
public class Players {
    ...
    public void load(UUID uuid) {
        ...
        this.teamIslandLocation<World> = playerInfo.getString("teamIslandLocation", "");
    ...
    public boolean hasIsland() {
        ...
        if (hasIsland && islandLocation.isEmpty()) {
            hasIsland = false;
            plugin.getLogger().warning(playerName + " apparently had an island, but the Location<World> is unknown.");
        }
        return hasIsland;
    }
            ...
            if (teamLeader == null) {
                ...
                if (plugin.getPlayers().getMembers(teamLeader).contains(uuid)) {
                    ...
                    if (plugin.getPlayers().getTeamIslandLocation(teamLeader) != null) {
                        teamIslandLocation<World> = Util.getStringLocation(plugin.getPlayers().getTeamIslandLocation(teamLeader));
    ...
    /**
     * @return the Location<World> of the player's island in Location<World> form
     */
    ...
    public Location<World> getTeamIslandLocation() {
        ...
        if (teamIslandLocation<World> == null || teamIslandLocation.isEmpty()) {
            return null;
        }
    ...
    /**
     * Stores the numbered home Location<World> of the player. Numbering starts at 1. 
     * @param location
     * @param number
     */
    public void setHomeLocation(final Location<World> location, int number) {
        if (Location<World> == null) {
            ...
            // Make the Location<World> x,y,z integer, but keep the yaw and pitch
    ...
    public void setIslandLocation(final Location<World> l) {
        islandLocation<World> = Util.getStringLocation(l);
    }
     ...
     * @param l
     *            - the Bukkit Location<World> of the team's island (converted to a
    ...
    public void setJoinTeam(final UUID leader, final Location<World> l) {
        ...
        inTeam = true;
        teamLeader = leader;
        teamIslandLocation<World> = Util.getStringLocation(l);
     ...
     * islandLevel, teamIslandLocation<World> and members array
     */
    ...
    public long getInviteCoolDownTime(Location<World> location) {
        // Check the hashmap
        if (Location<World> != null && kickedList.containsKey(location)) {
    ...
    /**
     * Starts the invite cooldown timer for location. Location<World> should be the center of an island.
     * @param location
     */
