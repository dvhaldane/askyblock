...
public class Settings {
    ...
    */
    ...
    public static HashSet<DamageSource> visitorDamagePrevention;
    ...
    // Levels
    public static HashMap<BlockState, Integer> blockLimits;
    public static HashMap<BlockState, Integer> blockValues;
    ...
    public static BiomeType defaultBiome;
    ...
    public static TreeMap<Integer,TreeMap<Double,BlockType>> magicCobbleGenChances;
